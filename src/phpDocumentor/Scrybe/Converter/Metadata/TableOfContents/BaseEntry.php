...
abstract class BaseEntry
{
     ...
     *
     * This property may also contain a null value if this is the top entry in
     * this module. Please note that files are also considered entries.
     *
     ...
     *
     * Any entry may contain any amount of child entries which may either be
     * Headings or Files.
     *
     * @var BaseEntry[]
     */
     ...
     * @param BaseEntry|null $parent
     *
     * @throws \InvalidArgumentException if the given parameter is of an
     *     incorrect type.
     *
     * @return void
     */
