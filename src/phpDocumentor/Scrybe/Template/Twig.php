...
class Twig implements TemplateInterface
{
     ...
     *
     * @param string $name A template name that may be composed of alphanumeric
     *     characters, underscores and/or hyphens.
     *
     * @throws \InvalidArgumentException if the name does not match the
     *   prescribed format.
     *
     * @return void
     */
     ...
     *
     * The file extension of the destination format needs to be set. This is
     * used to retrieve the correct template.
     *
     * @param string $extension an extension (thus only containing alphanumeric
     *     characters and be between 2 and 4 characters in size).
     *
     * @throws \InvalidArgumentException if the extension does not match the
     *     validation restrictions mentioned above.
     *
     * @return void
     */
     ...
     *
     * This method takes the combines the template with the given contents and
     * generates a final piece of text from that.
     *
     * The user may add additional options that are set as parameters in the
     * template.
     *
     ...
     *
     * This uses the path as defined with this class to instantiate a new
     * Environment and disables the escaping mechanism since we use it to
     * generate HTML; even embedded.
     *
